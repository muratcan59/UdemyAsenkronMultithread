...
namespace PLINQApp.Models
{
    public partial class AdventureWorks2017Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-5LHOHK1\\MURAT;Initial Catalog=AdventureWorks2017;User ID=sa;Password=sa123;Connect Timeout=30;MultipleActiveResultSets=true;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            }
        }
